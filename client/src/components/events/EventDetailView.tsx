        ...
        <main className="max-w-7xl mx-auto px-8 py-8 flex flex-col gap-8">
          ...
          >
            ...
            <div className="flex flex-col gap-4 bg-[#141417] border border-zinc-800/80 rounded-3xl p-6 h-fit">
              ...
              <button
                type="button"
                className="w-full border border-zinc-700 text-white font-semibold py-3.5 rounded-2xl flex items-center justify-center gap-2 hover:border-zinc-500 transition-colors text-base"
              >
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6">
              {relatedEvents.map((relEvent) => (
                <EventCardWeb key={relEvent.id} event={relEvent} variant="grid" instanceId="web-related" />
              ))}
            </div>
          </motion.section>
        </main>
        ...
        >
          {onClose ? (
            <button
              type="button"
              onClick={onClose}
              className="p-2 bg-zinc-900 border border-zinc-800 rounded-full text-white"
          ...
          <button type="button" className="p-2 bg-zinc-900 border border-zinc-800 rounded-full text-white">
        ...
        <main className="p-4 flex flex-col gap-4">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                type="button"
                className="border border-zinc-700 text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2 text-sm"
              >
            ...
            <div className="bg-[#141417] border border-zinc-800 rounded-2xl p-4 flex items-center justify-between">
              <div>
                ...
                <button type="button" className="flex items-center gap-1 text-[#CCFF00] font-bold text-xs mt-2">
                  <span>Open map</span>
